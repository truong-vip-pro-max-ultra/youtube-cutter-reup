...
"""
    ...
    def process(self):
        ...
        try:
            ...
            def _show_done(msg=msg, out_dir=out_dir):
                ...
                tk.Label(dlg, text="✓  Tạo video thành công!",
                         bg=APP_BG, fg=SUCCESS,
                         font=(UI_FONT, 13, "bold")).pack(padx=24, pady=(18, 6))
                tk.Label(dlg, text=msg, bg=APP_BG, fg=TEXT_SECONDARY,
                         font=(UI_FONT, 9), justify="left").pack(padx=24, pady=(0, 16))
                ...
                def _open_folder():
                    if IS_MAC:
                        ...
                        subprocess.Popen(["explorer", out_dir], creationflags=SUBPROCESS_FLAGS)
                    else:
                ...
                FlatButton(btn_row, "Đóng", command=dlg.destroy,
                           height=38, font=(UI_FONT, 10), padx=24
                           ).pack(fill="x")
